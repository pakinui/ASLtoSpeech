...
\char`\"{}\+Guideline for American Sign Language\char`\"{} \hypertarget{md__r_e_a_d_m_e_autotoc_md4}{}\doxysection{Badges}\label{md__r_e_a_d_m_e_autotoc_md4}
...
\item An analysis on user testing \href{https://github.com/pakinui/cosc345/blob/main/PDFs/user_testing_review.pdf}{\texttt{ here}}~\newline

\item Laura has drawn an amazing ASL sign language guide for our application as seen at the top of the README \+:)
