...
\DoxyCodeLine{\$ Ignore me please. Not yet used.}

\end{DoxyCode}
\hypertarget{md__r_e_a_d_m_e_autotoc_md11}{}\doxysubsection{Usage}\label{md__r_e_a_d_m_e_autotoc_md11}
How users can use your project. Code examples, command-\/line usage, or screenshots if relevant. N/A Currently.\hypertarget{md__r_e_a_d_m_e_autotoc_md12}{}\doxysubsection{Configuration}\label{md__r_e_a_d_m_e_autotoc_md12}
If your project has configuration options, APIs, or settings that can be customized, explain how users can configure these. Include examples and explanations. N/A Currently.\hypertarget{md__r_e_a_d_m_e_autotoc_md13}{}\doxysubsection{Codecov Coverage Graph}\label{md__r_e_a_d_m_e_autotoc_md13}
