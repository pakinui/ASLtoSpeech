...
\item Full working CI pipeline (see Assignment 2’s requirements) \+:question\+:
\item Program that is nearly finished \+:white\+\_\+check\+\_\+mark\+:
\item Through and extensive testing \+:question\+:
\item Increased coverage reports \+:question\+:
...
We received zero marks for cool points from the Alpha.~\newline
 What we believe was cool from the {\bfseries{Alpha}} that was no acknowledged\+:~\newline
