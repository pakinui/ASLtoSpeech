...
\end{DoxyCode}
 Open the CMake\+Lists.\+txt file in Ot6.\+5.\+2 Insert \textquotesingle{}\textbackslash{}cosc345\textbackslash{}build\textquotesingle{} into the build directory between the parent directory and the build directory i.\+e.(...\textbackslash{}parent-\/directory\textbackslash{}cosc345\textbackslash{}build\textbackslash{}build-\/cosc345...) Build and Run the Application in Release mode \DoxyHorRuler{0}
