...
Upon opening the app, you should be able to see yourself in the webcam frame. There is a box to the right that will have the letters signed added to it (after the bar under the cam is filled), and pressing translate speaks that sentence, as well as moves that sentence to the larger box above, displaying the history of what has been said. This is the default tab ("Translation"), however you can change to the "History" tab to see the history of chat in more depth, as well as a "Dictionary" tab to see the hand symbol to letter chart drawn by Laura.
